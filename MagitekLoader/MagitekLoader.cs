...
public class CombatRoutineLoader : CombatRoutine
{
    ...
    private const string ZipUrl = "https://github.com/cheesegoldfish/MagitekRoutine/releases/latest/download/Magitek.zip";
    private const string VersionUrl = "https://github.com/cheesegoldfish/MagitekRoutine/releases/latest/download/Version.txt";
